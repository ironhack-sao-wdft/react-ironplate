...
export default function ActivityDescription() {
  ...
  return (
    <div>
      ...
      <section className="d-flex flex-column justify-content-center align-items-center pb-4">
        <span
          style={{ fontSize: "2.2rem", fontWeight: "400", color: "#FBF8F3" }}
        >
          today's{" "}
        </span>
        <span
      ...
      <div style={{ boxShadow: "100px 0px 0px 0px rgba(0, 0, 0, 0.25)" }}>
        <ActivityCard cardArr={cardArr} handleBlock={handleBlock} />
      </div>
    </div>
  );
}
